...
class QAModel(object):
    ...
    def build_graph(self):
        ...
        #_, attn_output = attn_layer.build_graph(question_hiddens, self.qn_mask, self.context_mask, context_hiddens) # attn_output is shape (batch_size, context_len, hidden_size*2)
        blended_reps = attn_layer.build_graph(question_hiddens, self.qn_mask, self.context_mask, context_hiddens) # attn_output is shape (batch_size, context_len, hidden_size*2)
